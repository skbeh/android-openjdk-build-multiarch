...
export CFLAGS+=" -DLE_STANDALONE -DANDROID -pipe -integrated-as -Ofast -flto -mllvm -polly -fno-plt -mllvm -polly-vectorizer=polly -mllvm -polly-invariant-load-hoisting -mllvm -polly-run-inliner -mllvm -polly-run-dce"
